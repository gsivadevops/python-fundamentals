...
print("sample_str[8]: ", sample_str[8])

# Slicing
sub_str = sample_str[2:7]
print("sub_str - sample_str[2:7]: ", sub_str)

sub_str = sample_str[:]
print("sub_str - sample_str[:]: ",sub_str)

sub_str = sample_str[1:]
print("sub_str - sample_str[1:]: ",sub_str)

sub_str = sample_str[:5]
print("sub_str - sample_str[:5]: ",sub_str)

sub_str = sample_str[::2]
print("sub_str - sample_str[::2]: ",sub_str)

# Reverse a string
sub_str = sample_str[::-1]
print("Reverse string - sample_str[::-1]: ", sub_str)

# Length of a string
len_str = len(sample_str)
print("Length of a string - len(sample_str): ", len_str)
